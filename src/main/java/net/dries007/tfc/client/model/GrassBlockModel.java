...
public class GrassBlockModel implements IStaticBakedModel, IUnbakedGeometry<GrassBlockModel>
{
    ...
    {
        final boolean snow = (state.hasProperty(ConnectedGrassBlock.SNOWY) && !state.getValue(ConnectedGrassBlock.SNOWY)) &&
                             level.getBrightness(LightLayer.SKY, pos) > 3 &&
    ...
    {
        snowBakedModel = snowModel.bake(baker, snowModel, atlas, modelState, false);
        grassBakedModel = grassModel.bake(baker, grassModel, atlas, modelState, false);
        return this;
    }
